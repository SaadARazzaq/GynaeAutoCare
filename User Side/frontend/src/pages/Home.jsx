          ...
          <div className="flex flex-col lg:flex-row gap-[90px] items-center justify-between">
            ...
            <div>
              <div className=" lg:w-[570px]">
                ...
                Empowering Women's Health with GynaeAutocare: Your Trusted Partner in Holistic Gynecological Wellness. Where Patient Health is our Number 1 Priority.
                </p>
        ...
        <div className="container ">
          <div className="lg:w-[470px] mx-auto">
            <h2 className="heading text-center">
              Providing the Best Gynae Services
            </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 lg:gap-[30px] mt-[30px] lg:mt-[55px]">
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                Discover Expertise Tailored to You – Uncover Your Ideal Healthcare Partner with GynaeAutocare's Doctor Search
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                Navigating Wellness Near You – GynaeAutocare's Network of Careful Consideration and Convenient Locations
            ...
            <div className="py-[30px] px-5 ">
              ...
              <div className="mt-[30px]">
                ...
                <p className="text-[16px] leading-7 text-textColor font-[400] mt-4 text-center">
                Seamlessly Connect with Your Health – Elevate Your Experience with GynaeAutocare's Effortless Appointment Booking
                </p>
      ...
      <section>
        <div className="container">
          <div className="xl:w-[470px] mx-auto">
            ...
            <p className="text__para text-center">
            Experience top-notch care with our world-class doctors at GynaeAutocare.
            </p>
          </div>
